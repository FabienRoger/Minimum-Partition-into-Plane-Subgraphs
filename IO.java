...
public class IO {
	...
	*/
	...
	//TODO : A corriger, pas de classe Instance
	/*
	public static boolean checkOutputFile(String filename, Instance instance){
		...
		if(colors ==null || colors.length!=instance.m)
	...
	*/
    ...
    public static void saveSolutionToJSON(GraphSolution solution, String output) {
		...
		//TODO : Problème du edgeColors qui est un map et pas une liste
