...
public class GraphViewer extends PApplet {
	...
	public static int xmin = Integer.MAX_VALUE, xmax = Integer.MIN_VALUE, ymin = Integer.MAX_VALUE, ymax = Integer.MIN_VALUE;
	...
	public void keyPressed(){
		...
		switch(key) {
		case('+'): this.scaleFactor*=1.2; break;
		case('-'): this.scaleFactor*=1.2; break;
	...
	public void mousePressed() {
		...
		TODO : This if/else is not implemented yet
		  ...
		  if (this.exportJson.mouseIsOver()) {
			    ...
			    IO.checkOutputFile("output.json", this.instance); // check output format of the solution
		  }
		  else {
		  }
		  */
	...
	public int[] getPixel(double x, double y) {
		...
		int i= (int) ((f*GraphViewer.sizeX)*( (x-GraphViewer.xmin) / this.layoutWidth )); // scale with respect to the canvas dimension
